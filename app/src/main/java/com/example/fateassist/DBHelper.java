...
public class DBHelper {
    ...
    */
    ...
    public void AddTestCharacters(Context context){
        ...
        charData.putByteArray("IMG",      mybytes);

        AddCharacter(context, charData);

        charData.putString("CHAR_NAME",   "CHAR_NAME   2");
        charData.putString("DESCRIPTION", "DESCRIPTION 2");
        charData.putString("ASPECTS",     "ASPECTS     2");
        charData.putString("STUNTS",      "STUNTS      2");
        charData.putString("EXTRAS",      "EXTRAS      2");
        charData.putString("C2",          "C2          2");
        charData.putString("C4",          "C4          2");
        charData.putString("C6",          "C6          2");
        charData.putString("AV1",         "AV1         2");
        charData.putString("AV2",         "AV2         2");
        charData.putString("AV3",         "AV3         2");
        charData.putString("AV4",         "AV4         2");
        charData.putString("AV5",         "AV5         2");
        charData.putString("FA1",         "FA1         2");
        charData.putString("FA2",         "FA2         2");
        charData.putString("FA3",         "FA3         2");
        charData.putString("FA4",         "FA4         2");
        charData.putString("FA5",         "FA5         2");
        charData.putString("GO1",         "GO1         2");
        charData.putString("GO2",         "GO2         2");
        charData.putString("GO3",         "GO3         2");
        charData.putString("GO4",         "GO4         2");
        charData.putString("GO5",         "GO5         2");
        charData.putString("GR1",         "GR1         2");
        charData.putString("GR2",         "GR2         2");
        charData.putString("GR3",         "GR3         2");
        charData.putString("GR4",         "GR4         2");
        charData.putString("GR5",         "GR5         2");
        charData.putString("SU1",         "SU1         2");
        charData.putString("SU2",         "SU2         2");
        charData.putString("SU3",         "SU3         2");
        charData.putString("SU4",         "SU4         2");
        charData.putString("SU5",         "SU5         2");
        charData.putInt("REFRESH",        1233);
        charData.putInt("FP",             1233);
        charData.putBoolean("PS1",        true);
        charData.putBoolean("PS2",        true);
        charData.putBoolean("PS3",        true);
        charData.putBoolean("PS4",        true);
        charData.putBoolean("MS1",        true);
        charData.putBoolean("MS2",        true);
        charData.putBoolean("MS3",        true);
        charData.putBoolean("MS4",        true);
        charData.putByteArray("IMG",      mybytes);

        AddCharacter(context, charData);
        charData.putString("CHAR_NAME",   "CHAR_NAME   3");
        charData.putString("DESCRIPTION", "DESCRIPTION 3");
        charData.putString("ASPECTS",     "ASPECTS     3");
        charData.putString("STUNTS",      "STUNTS      3");
        charData.putString("EXTRAS",      "EXTRAS      3");
        charData.putString("C2",          "C2          3");
        charData.putString("C4",          "C4          3");
        charData.putString("C6",          "C6          3");
        charData.putString("AV1",         "AV1         3");
        charData.putString("AV2",         "AV2         3");
        charData.putString("AV3",         "AV3         3");
        charData.putString("AV4",         "AV4         3");
        charData.putString("AV5",         "AV5         3");
        charData.putString("FA1",         "FA1         3");
        charData.putString("FA2",         "FA2         3");
        charData.putString("FA3",         "FA3         3");
        charData.putString("FA4",         "FA4         3");
        charData.putString("FA5",         "FA5         3");
        charData.putString("GO1",         "GO1         3");
        charData.putString("GO2",         "GO2         3");
        charData.putString("GO3",         "GO3         3");
        charData.putString("GO4",         "GO4         3");
        charData.putString("GO5",         "GO5         3");
        charData.putString("GR1",         "GR1         3");
        charData.putString("GR2",         "GR2         3");
        charData.putString("GR3",         "GR3         3");
        charData.putString("GR4",         "GR4         3");
        charData.putString("GR5",         "GR5         3");
        charData.putString("SU1",         "SU1         3");
        charData.putString("SU2",         "SU2         3");
        charData.putString("SU3",         "SU3         3");
        charData.putString("SU4",         "SU4         3");
        charData.putString("SU5",         "SU5         3");
        charData.putInt("REFRESH",        1233);
        charData.putInt("FP",             1233);
        charData.putBoolean("PS1",        true);
        charData.putBoolean("PS2",        true);
